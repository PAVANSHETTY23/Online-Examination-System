...
require_once 'sql.php';
    ...
    if (isset($_POST['submit3'])) {
        ...
        $res1 = mysqli_query($conn, $sql1);
        if ($res1 == true) {
            echo "<script>window.location.replace(\"updateselector.php?qid=".$qid1."\");</script>";
        } else {
            echo "<script>alert(\"Unknown error occured during viweing of quiz\");</script>";
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, monospace;height:auto;color:#fff">
    <div id="main" style="background-color: #042A38;height: auto;color:#fff !important">
        ...
        <section class="dash" style="margin: 5vw;width: 90vw;">
           ...
           <center> <button onclick="addquiz()">Add Quiz</button>            <button onclick="delquiz()">Delete Quiz</button>         <button onclick="viewq()">View Quiz</button>         <button onclick="updateselector()">Update Quiz</button></center>
           <center>
            ...
            <section id="updateselector" style="display:none;">
                <form style="margin: 1vw;width: 30vw" method="post">
                    
                        <h1>Update Quiz</h1>
                        <label for="quizid">Quiz Id</label>
                        <input type="number" name="quizid" placeholder="enter quiz id" required><h7 onclick="score()" style="padding:0;color: #fff;font-size:1vw;text-decoration:underline">get Quiz ID</h7><br><br>
                        <input type="submit" name="submit3" value="submit" style="height: 3vw;width: 10vw;font-family: 'Courier New', Courier, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
...
echo "window.location.replace(\"index.php\");" .
    ...
    "document.getElementById(\"updateselector\").style=\"display: none;\";" .
    "}" .
    "function updateselector(){" .
        "document.getElementById(\"updateselector\").style=\"display: initial;\";" .
        "document.getElementById(\"delq\").style=\"display: none;\";" .
